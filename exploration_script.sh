...
sudo apt update
#ommand is used in Debian-based Linux distributions (like Ubuntu, Linux Mint, and Kali) to install the latest versions of all packages currently installed on your system
sudo apt upgrate
